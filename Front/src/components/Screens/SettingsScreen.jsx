...
import TicketsForms from "../forms/TicketsForms";
import ServiceTimeConfigForms from "../forms/ServiceTimeConfigForms";
      ...
      <div className="h-full flex flex-col items-stretch">
        <div className="grow flex flex-row justify-stretch gap-4">
          ...
          <div className="basis-1/4 grow h-full flex flex-col">
            <BaseHeader className="mb-4">Configuração de Ingresso</BaseHeader>
          ...
          {/* Col2 */}
          <div className="basis-1/4 grow h-full flex flex-col">
            <BaseHeader className="mb-4">Liberação de Atendimentos</BaseHeader>

            <ServiceTimeConfigForms
              dataRef={searchData}
              className="grow flex flex-col items-stretch"
              editableFields={["*"]}
            />
            ...
            <div className="flex justify-center space-between gap-8 my-5">
              ...
              >
                <PanelLeftOpen className="inline" /> Liberar Atendimentos
              </button>
            </div>
          </div>
          ...
          {/* Col 3 */}
          <div className="basis-1/4 grow h-full flex flex-col">
            <BaseHeader className="mb-4">Fechamento de Atendimentos</BaseHeader>
            ...
            <div className="flex justify-center space-between gap-8 my-5">
              ...
              >
                <PanelLeftOpen className="inline" /> Fechar Atendimentos
              </button>
            </div>
          </div>
        </div>
